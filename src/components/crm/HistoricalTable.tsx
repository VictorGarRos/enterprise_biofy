                    ...
                    <thead>
                        <tr className="bg-gray-50">
                            {['Fecha / Hora', 'Tipo', 'Asesor', 'Cuenta / Ubicación', 'Acción'].map((h, i) => (
                                <th key={h} className={`px-3 md:px-6 py-3 md:py-3.5 text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 ${i === 4 ? 'text-right' : 'text-left'}`}>
                                    {h}
                                </th>
                            ))}
                        </tr>
                    ...
                    <tbody className="divide-y divide-gray-50">
                        {data.map((row, i) => (
                            <tr key={i} className="hover:bg-gray-50/80 transition-colors group">
                                <td className="px-3 md:px-6 py-2.5 md:py-3.5 whitespace-nowrap">
                                ...
                                <td className="px-3 md:px-6 py-2.5 md:py-3.5">
                                ...
                                <td className="px-3 md:px-6 py-2.5 md:py-3.5 max-w-xs truncate">
                                ...
                                <td className="px-3 md:px-6 py-2.5 md:py-3.5 text-right">
